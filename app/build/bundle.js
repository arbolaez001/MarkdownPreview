...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MarkdownEditor = __webpack_require__(168);
	...
	_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('mainApp'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MarkdownEditor = _react2.default.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return {
	      markdownValue: "*Testing* the markdown!"
	    };
	  },
	  markOnChange: function markOnChange(e) {
	    this.setState({
	      markdownValue: this.refs.textarea.value
	    });
	  },
	  processMarkdown: function processMarkdown() {
	    return { __html: (0, _marked2.default)(this.state.markdownValue, { sanitize: true }) };
	  },
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('textarea', {
	          ...
	          rows: '20',
	          defaultValue: this.state.markdownValue,
	          ref: 'textarea',
	          onChange: this.markOnChange
	        })
	      ),
	      _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement('div', {
	          dangerouslySetInnerHTML: this.processMarkdown()
	        })
	      )
	    );
	  }
